...
RECOMMENDATIONS_CATALOG: dict[str, dict[str, Any]] = {
    "community_recognition": {
        ...
        "priority": "low",
        "reason": "Neighborhood is operating below the efficient usage cutoff.",
    ...
    "demand_response_outreach": {
        ...
        "priority": "medium",
        "reason": "Encourage households to participate in peak-reduction programs.",
    ...
    "insulation_improvements": {
        ...
        "priority": "medium",
        "reason": "Address likely building envelope losses that increase consumption.",
    ...
    "hvac_upgrades": {
        ...
        "priority": "high",
        "reason": "HVAC modernization can reduce sustained high household intensity.",
...
def get_catalog_recommendation(recommendation_id: str) -> dict[str, Any]:
    """Return one recommendation object from the catalog by id."""
    recommendation = RECOMMENDATIONS_CATALOG.get(recommendation_id)
    if recommendation is None:
        raise KeyError(f"Unknown recommendation id: {recommendation_id}")
