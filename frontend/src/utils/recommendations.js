/**
 * Transforms GET /api/analytics/recommendations payload into one row per rule per neighborhood.
 * Backend shape: [{ neighborhood_id, neighborhood, score, triggered_conditions, recommendations: [...] }, ...]
 */
export function flattenRecommendationsPayload(bundles) {
